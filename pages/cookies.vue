<template>
  <div class="container py-5">
    <h1 class="txt_center text_primary">Cookies Policy</h1>
    ...
    <p>
      ...
      <a href="https://www.termsfeed.com/cookies-policy-generator/" target="_blank">Cookies Policy Generator</a>.
    </p>
    ...
    <ul>
      <li>
        ...
        &quot;Our&quot; in this Cookies Policy) refers to Fiction to mission, Av. Hédi Nouira,Sfax El Jadida, imm Fourat
        3ème étage App. N°306, 3027 Sfax, Tunisia.
      </li>
      <li>
        <strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by
        a website, containing details of your browsing history on that website among its many uses.
      </li>
      <li>
        <strong>Website</strong> refers to https://fiction-to-mission.com, accessible from [Fiction to mission](Fiction to
        mission)
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: Info@fiction-to-mission.com</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:
          <a href="https://fiction-to-mission.com/contact" rel="external nofollow noopener"
            target="_blank">https://fiction-to-mission.com/contact</a>
        </p>
      </li>
      <li>
        <p>By phone number: +21692243333</p>
      </li>
      <li>
        <p>By mail: Av. Hédi Nouira,Sfax El Jadida, imm Fourat 3ème étage App. N°306, 3027 Sfax, Tunisia</p>
      </li>
    </ul>
  </div>
</template>
