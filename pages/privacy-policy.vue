<template>
  <div class="container py-5">
    <h1 class="txt_center text_primary">Privacy Policy</h1>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          &quot;Our&quot; in this Agreement) refers to Fiction to mission, Av. Hédi Nouira,Sfax El Jadida, imm Fourat 3ème
          étage App. N°306, 3027 Sfax.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Fiction to mission, accessible from
          <a href="https://www.fiction-to-mission.com" rel="external nofollow noopener"
            target="_blank">https://www.fiction-to-mission.com</a>
        </p>
      </li>
      <li>
        <p>
    ...
    <p>
      ...
      <a href="https://www.termsfeed.com/privacy-policy-generator/#faq-8" target="_blank">Cookies by TermsFeed
        Generator</a>.
    </p>
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        <a href="https://www.fiction-to-mission.com/contact" rel="external nofollow noopener"
          target="_blank">https://www.fiction-to-mission.com/contact</a>
      </p>
    </li>
    <li>
